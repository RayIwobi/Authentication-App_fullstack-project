...
function UpdateDetails() {
    ...
    useEffect(() => {
     axios.get('https://authenticate-app.vercel.app/auth/dashboard',{ withCredentials: true })
    ...
    const handleclick = () =>{
      axios.put('https://authenticate-app.vercel.app/auth/update', profile, { withCredentials: true})
